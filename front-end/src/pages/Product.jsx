      ...
      <div className="container container--produto">
        ...
        <div className="informacoes">
          ...
          <div className="informacoes__caracteristicas">
            <h2>O que você precisa saber desses produtos</h2>
        ...
        <div className="pedido">
          ...
          <div className="pedido__estoque">
            <p className="bold">Estoque disponível</p>
            {produto.full ? (
              <div className="pedido__full">
                <p className="cinza-escuro">Armazenado e enviado pelo</p>
                <div className="produto__full">
                  <svg
          ...
          <div className="pedido__quantidade">
            <p className="preto-80">Quantidade</p>
            <select
            ...
            <p className="cinza-escuro">({produto.estoque}disponíveis)</p>
          </div>
          <button
            onClick={() => {
              adicionarProduto(quantidade, produto);
            }}
          >
